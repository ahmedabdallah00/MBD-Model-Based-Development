...
typedef struct {
  ...
  codertarget_arduinobase_int_a_T obj_l;/* '<Root>/PWM1' */
  boolean_T objisempty;                /* '<Root>/PWM1' */
  boolean_T objisempty_n;              /* '<Root>/Analog Input' */
} DW_PWM_signal_T;

/* Real-time Model Data Structure */
struct tag_RTM_PWM_signal_T {
...
extern DW_PWM_signal_T PWM_signal_DW;

/* Model entry point functions */
extern void PWM_signal_initialize(void);
extern void PWM_signal_step(void);
extern void PWM_signal_terminate(void);

/* Real-time Model object */
extern RT_MODEL_PWM_signal_T *const PWM_signal_M;
