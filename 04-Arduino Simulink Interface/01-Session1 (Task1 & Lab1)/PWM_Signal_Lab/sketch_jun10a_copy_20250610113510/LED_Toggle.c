 ...
 * File: LED_Toggle.c
 *
 * Code generated for Simulink model 'LED_Toggle'.
 *
 * Model version                  : 1.1
 * Simulink Coder version         : 24.2 (R2024b) 21-Jun-2024
 * C/C++ source code generated on : Wed Jun 11 09:08:16 2025
 *
...
void LED_Toggle_step(void)
{
  ...
  rtDW.obj_l.PWMDriverObj.MW_PWM_HANDLE = MW_PWM_GetHandle(6UL);
  ...
  /* MATLABSystem: '<Root>/PWM1' */
  MW_PWM_SetDutyCycle(rtDW.obj_l.PWMDriverObj.MW_PWM_HANDLE, u0);
}

/* Model initialize function */
void LED_Toggle_initialize(void)
{
  /* Registration code */
  ...
  rtDW.obj_l.PWMDriverObj.MW_PWM_HANDLE = MW_PWM_Open(6UL, 0.0, 0.0);
