...
#ifndef typedef_codertarget_arduinobase_block_j
#define typedef_codertarget_arduinobase_block_j

typedef struct tag_ldqgYDWP5Rq6U8J4ptL7cG codertarget_arduinobase_block_j;

#endif                             /* typedef_codertarget_arduinobase_block_j */

/* Block signals and states (default storage) for system '<Root>' */
typedef struct {
  codertarget_arduinobase_block_j obj_l;/* '<Root>/Digital Output2' */
  codertarget_arduinobase_block_j obj_b;/* '<Root>/Digital Output1' */
  codertarget_arduinobase_block_j obj_j;/* '<Root>/Digital Output' */
  codertarget_arduinobase_blocks_ obj; /* '<Root>/Digital Input' */
  real_T RLed;                         /* '<Root>/Traffic_Led_State' */
  real_T GLed;                         /* '<Root>/Traffic_Led_State' */
  real_T YLed;                         /* '<Root>/Traffic_Led_State' */
  uint8_T is_active_c4_traffic_light;  /* '<Root>/Traffic_Led_State' */
  uint8_T is_c4_traffic_light;         /* '<Root>/Traffic_Led_State' */
  uint8_T is_FaultMode;                /* '<Root>/Traffic_Led_State' */
  uint8_T is_NormalMode;               /* '<Root>/Traffic_Led_State' */
  uint8_T temporalCounter_i1;          /* '<Root>/Traffic_Led_State' */
} DW;
...
extern void traffic_light_SetEventsForThisBaseStep(boolean_T *eventFlags);

/* Model entry point functions */
extern void traffic_light_initialize(void);
extern void traffic_light_step0(void); /* Sample time: [0.001s, 0.0s] */
extern void traffic_light_step1(void); /* Sample time: [0.1s, 0.0s] */
 ...
 *
 * '<Root>' : 'traffic_light'
 * '<S1>'   : 'traffic_light/Traffic_Led_State'
 */
